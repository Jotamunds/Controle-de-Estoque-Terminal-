    ...
    while True:
        ...
        match escolha:
            ...
            case 3:
                ...
                cursor.execute(f"DELETE FROM Produtos WHERE id = ?", (id,)) # quando for passar um único valor deve ser colocada a vírgula para o python entender que é uma tupla com valores
                conexao.commit()
